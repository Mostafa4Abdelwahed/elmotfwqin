  ...
  return (
    <>
      <ReactPaginate
        ...
        containerClassName="flex items-center justify-center gap-x-4 my-10"
        ...
        previousLinkClassName="bg-primary hover:bg-primary/60 text-white px-7 py-2 rounded inline-flex items-center md:mr-8 mr-1"
