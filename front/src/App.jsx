    ...
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/profile" element={<LayoutProfile />}>
          ...
          <Route path=":lang/teachers/:teacher/units" element={<Units />} />
          <Route path=":lang/teachers/:teacher/units/:unity/:id" element={<Lesson />} />
          <Route path=":lang/teachers/:teacher/units/:unity/quiz/:id" element={<Quiz />} />
